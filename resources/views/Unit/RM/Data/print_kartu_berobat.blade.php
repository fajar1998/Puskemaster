...
<table>
    ...
    <tr>
        <td style="height:60px;width:300px;">Nama KK</td>
        <td style="width:30px">:</td>
        <td>{{ $cetak->kepala_keluarga }}</td>
    </tr>

    <tr>
        <td style="height:60px">Umur</td>
        <td>:</td>
        <td> 
    ...
    <tr>
        <td style="height:60px">Jenis Kelamin</td>
        <td>:</td>
        <td> {{ $cetak->jenkel }}</td>
    ...
    <tr>
        <td style="height:60px">Alamat</td>
        <td>:</td>
